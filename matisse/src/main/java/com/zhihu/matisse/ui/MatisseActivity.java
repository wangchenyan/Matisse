...
import com.zhihu.matisse.AppUtils;
...
public class MatisseActivity extends AppCompatActivity implements
    ...
    private void checkPermission(@Nullable Bundle savedInstanceState) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            onGrantPermission(savedInstanceState);
        } else {
            String[] permissions;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU
                    && AppUtils.INSTANCE.getAppTargetSdkVersion(this) >= Build.VERSION_CODES.TIRAMISU
            ) {
    ...
    public void onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CODE_PERMISSION) {
            ...
            if (allGrant) {
                ...
                Toast.makeText(
                        this,
                        R.string.matisse_not_grant_storage_permission,
                        Toast.LENGTH_SHORT
                ).show();
                finish();
            }
    ...
    private void onGrantPermission(@Nullable Bundle savedInstanceState) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PREVIEW) {
            ...
            int collectionType = resultBundle.getInt(
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                MatisseActivity.this.revokeUriPermission(
                        contentUri,
